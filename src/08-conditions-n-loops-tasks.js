...
function doRectanglesOverlap(rect1, rect2) {
  const botLeftRect1 = rect1.top + rect1.height;
  const botLeftRect2 = rect2.top + rect2.height;
  const botRightRect1 = rect1.left + rect1.width;
  const botRightRect2 = rect2.left + rect2.width;

  if (rect1.top >= botLeftRect2 || rect2.top >= botLeftRect1) {
    return false;
  }

  if (rect1.left >= botRightRect2 || rect2.left >= botRightRect1) {
    return false;
  }
